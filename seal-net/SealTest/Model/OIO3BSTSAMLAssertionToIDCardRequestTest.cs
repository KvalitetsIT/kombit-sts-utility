...
{
    class OIO3BSTSAMLAssertionToIDCardRequestTest
    {
        ...
        private AbstractOIOBSTSAMLAssertionBuilder<OIO3BSTSAMLAssertion> assertionBuilder;
        private OIOBSTSAMLAssertionToIDCardRequestDOMBuilder<OIO3BSTSAMLAssertion> requestBuilder;

        private readonly OIOBSTSAMLAssertion.Type tokenType = OIOBSTSAMLAssertion.Type.OIO3BST;


        [SetUp]
        public void Setup()
        {
            assertionBuilder = CreateOIO3BSTSAMLAssertionBuilder(holderOfKeyVault, assertionSigningVault);
        ...
        {
            AbstractOIOBSTSAMLAssertionBuilder<OIO3BSTSAMLAssertion> assertionBuilder = null;
        ...
        private void Validate(OIOBSTSAMLAssertion assertion)
        {
            ...
            else
            {
                ...
                Assert.AreEqual("Uventet Privilege", "urn:dk:healthcare:national-federation-role:code:41003:value:PlejeAssR3", assertion.BasicPrivileges.Privileges["urn:dk:gov:saml:cvrNumberIdentifier:20301823"].FirstOrDefault());
            }

            //Test getAttribute
            Assert.Null(assertion.GetAttributeValue("NonExistingAttribute"), "Uventet resultat af NonExistingAttribute");
            Assert.NotNull("Uventet resultat af OIO3BSTSAMLAssertion.Attribute.CVR", assertion.GetAttributeValue(OIO3BSTSAMLAssertion.SamlCvr.Name));
        }

        private OIOBSTSAMLAssertionToIDCardRequestDOMBuilder<OIO3BSTSAMLAssertion> RequestBuilderFromAssertionBuilder(ICredentialVault signingVault, AbstractOIOBSTSAMLAssertionBuilder<OIO3BSTSAMLAssertion> assertionBuilder)
        {
        ...
        private OIO3BSTSAMLAssertionBuilder CreateOIO3BSTSAMLAssertionBuilder(ICredentialVault holderOfKeyVault, ICredentialVault signingVault)
        {
            OIO3BSTSAMLAssertionBuilder builder = OIOSAMLFactory.CreateOIO3BSTSAMLAssertionBuilder();
            issuer = "https://oio3bst-issuer.dk";
