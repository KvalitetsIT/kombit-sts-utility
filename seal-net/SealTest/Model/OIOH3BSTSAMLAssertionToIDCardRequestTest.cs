...
{
    class OIOH3BSTSAMLAssertionToIDCardRequestTest
    {
        private readonly OIOBSTSAMLAssertionToIDCardRequestModelBuilder requestModelBuilder = OIOSAMLFactory.CreateOIOBSTSAMLAssertionToIDCardRequestModelBuilder();
        ...
        private AbstractOIOBSTSAMLAssertionBuilder<OIOH3BSTSAMLAssertion> assertionBuilder;
        private OIOBSTSAMLAssertionToIDCardRequestDOMBuilder<OIOH3BSTSAMLAssertion> requestBuilder;

        private readonly OIOBSTSAMLAssertion.Type tokenType = OIOBSTSAMLAssertion.Type.OIOH3BST;


        [SetUp]
        public void Setup()
        {
            assertionBuilder = CreateOIOH3BSTSAMLAssertionBuilder(holderOfKeyVault, assertionSigningVault);
        ...
        {
            AbstractOIOBSTSAMLAssertionBuilder<OIOH3BSTSAMLAssertion> assertionBuilder = null;
        ...
        private void Validate(OIOBSTSAMLAssertion assertion)
        {
            ...
            Assert.NotNull("Uventet resultat af OIOH3BSTSAMLAssertion.Attribute.CVR", assertion.GetAttributeValue(OIOH3BSTSAMLAssertion.SamlCvr.Name));
        }

        private OIOBSTSAMLAssertionToIDCardRequestDOMBuilder<OIOH3BSTSAMLAssertion> RequestBuilderFromAssertionBuilder(ICredentialVault signingVault, AbstractOIOBSTSAMLAssertionBuilder<OIOH3BSTSAMLAssertion> assertionBuilder)
        {
        ...
        private OIOH3BSTSAMLAssertionBuilder CreateOIOH3BSTSAMLAssertionBuilder(ICredentialVault holderOfKeyVault, ICredentialVault signingVault)
        {
            OIOH3BSTSAMLAssertionBuilder builder = OIOSAMLFactory.CreateOIOH3BSTSAMLAssertionBuilder();
            issuer = "https://oioh3bst-issuer.dk";
            ...
            assuranceLevel = "HIGH";
            builder.SetAssuranceLevel("NSIS", assuranceLevel);
            builder.Uuid = uuid;
            builder.Cvr = cvr;
