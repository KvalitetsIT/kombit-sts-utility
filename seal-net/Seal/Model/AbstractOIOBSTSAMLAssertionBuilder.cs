...
{
    public abstract class AbstractOIOBSTSAMLAssertionBuilder<S, T> : AbstractSamlBuilder<T> where S : AbstractOIOBSTSAMLAssertionBuilder<S, T> where T : OIOBSTSAMLAssertion
    {
        ...
        protected XNode CreateSubject()
        {
            ...
            subjectConfirmationDataElm.Add(new XAttribute("type", "KeyInfoConfirmationDataType"));
        ...
        {
            return base.CreateAttributeElement(attribute.Name, attribute.NameFormat, null, value);
        }
        ...
        public override T Build()
        {
            ...
            var y = new SealSignedXml(signedXml);
            y.CheckAssertionSignature();

            var x = new SealSignedXml(signedXelement);
            x.CheckAssertionSignature();
