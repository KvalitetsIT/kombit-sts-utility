...
{
    public class Oces3DistinguishedName : DistinguishedName
    {
         ...
         */
        public Oces3DistinguishedName(string distinguishedName)
        {
         ...
         * @throws PKIException if DN parsing fails
         */
        public Oces3DistinguishedName(X500DistinguishedName principal)
        {
